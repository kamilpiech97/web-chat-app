        ...
        <div class="col-3 px-0 messages-div" id="messages-div">
          <div class="bg-white">
            <div class="bg-gray px-4 py-2 bg-light d-flex">
              ...
              <a v-on:click="closeMenu();" class="mobile-close">
            ...
            <div class="messages-box">
              <div class="list-group rounded-0">
                ...
                <div
                  ...
                  :class="[user.id===authUser.uid?'d-none':'']"
                >
        ...
        <div class="col-lg-9 px-0 chat-div">
          <div class="px-4 py-5 chat-box bg-white">
            ...
            <div
              ...
              class="media w-50 mb-3 active"
              :class="[item.username===authUser.displayName?'ml-auto':'']"
            >
              <div class="media-body ml-3">
                <div
                  class="rounded py-2 px-3 mb-2"
                  :class="[item.username===authUser.displayName?'bg-primary':'bg-light']"
                >
                  <p
                    class="text-small mb-0"
                    :class="[item.username===authUser.displayName?'text-white':'text-muted']"
                  >{{item.message}}</p>
                </div>
          ...
          <div class="input-group">
            ...
            <div class="input-group-append">
              <button id="button-addon3" class="btn btn-link">
